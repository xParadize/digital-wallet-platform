    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(request -> request
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/v1/auth/confirm-email/{code}").permitAll()
                        .requestMatchers(HttpMethod.POST, "/api/v1/auth/change-password").hasAnyRole("USER", "ADMIN", "VERIFIED_EMAIL")
